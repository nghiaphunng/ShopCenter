...
import shopcenter.com.core.entity.*;
//import shopcenter.com.entity.Review;
//import shopcenter.com.entity.Category;
import shopcenter.com.adapter.dto.request.create_product.CreateProductVariantRequest;
import shopcenter.com.adapter.dto.request.create_product.CreateVariantAttributeRequest;
//import shopcenter.com.entity.Category;
...
import shopcenter.com.adapter.dto.response.home.ProductResponse;
import shopcenter.com.adapter.dto.response.home.ProductVariantResponse;
import shopcenter.com.adapter.dto.response.home.UserResponse;
import shopcenter.com.adapter.dto.response.home.VariantAttributeResponse;
import shopcenter.com.adapter.dto.response.create_product.CreateProductResponse;
import shopcenter.com.adapter.dto.response.create_product.CreateProductVariantResponse;
import shopcenter.com.adapter.dto.response.create_product.CreateVariantAttributeResponse;
...
//			mapper.map(src -> src.getProductVariants(), ProductResponse::setProductVariantResponses);
		...
		//chuyển đổi RoleRequest -> Role
        modelMapper.typeMap(RoleRequest.class, Role.class).addMappings(mapper -> {
        	mapper.map(RoleRequest::getRoleName, Role::setRoleName);
        	mapper.map(RoleRequest::getRoleDesc, Role::setRoleDesc);
        });
		return modelMapper;
	}
}
